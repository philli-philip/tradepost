...
export default function DateSelector({ period }: { period: Period }) {
  return (
    <div className="flex">
      <div className="flex flex-row overflow-hidden flex-grow-0 gap-1 p-[2px] rounded-lg shrink bg-gray-200 dark:bg-gray-200">
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive && "bg-white hover:bg-gray-50 dark:bg-gray-100"
      )}
    >
      {children}
    </Link>
